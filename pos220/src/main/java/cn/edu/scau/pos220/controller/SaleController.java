...
public class SaleController {
     ...
     */
    @GetMapping("/makePayment/{cashTendered}")
    public AjaxResult makePayment(@PathVariable BigDecimal cashTendered){
        return AjaxResult.success(saleService.makePayment(cashTendered));
    }
